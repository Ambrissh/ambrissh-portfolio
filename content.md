...
Programming:
Python (NumPy, Pandas, Matplotlib), C++, Bash, LaTeX, MATLAB

ML / RL:
PyTorch, JAX, Scikit-Learn, CleanRL, Gymnasium, Stable Baselines3
...
Codeforces Div. 2 (daily)

# SOCIAL LINKS

Email:
ambrissh23@iiserbpr.ac.in

GitHub:
https://github.com/Ambrissh

LinkedIn:
https://www.linkedin.com/in/ambrissh-s-raghav-9bbb12218/
...
GitHub:
https://github.com/Ambrissh/loopthru.git
...
GitHub:
https://github.com/Ambrissh/cognitive-drift.git
...
Link:
https://youtu.be/-D1unPd46Ks?si=UEH32PZxqXA66awB
...
Link:
https://youtu.be/x5XyQ-asd6Q?si=EkZDTcqkdN5kbb-q
...
Link:
https://youtu.be/fFIbhT_AptM?si=EiEkhnNYZ537YS4p

# OTHER PODCASTS

https://youtu.be/9Rx6xjjVgDQ?si=dFcOGDaq6rbGhsyU

https://youtu.be/GKVjxPe0IM8?si=HIFOMdpim_gp0PNv

# CONTACT PAGE

Funny Intro:
These are just casual questions I genuinely enjoy asking people — no judgment, no pressure, just curiosity :)

Questions:

1. What problem are you obsessed with solving?

2. What are you currently building or exploring?

3. If resources weren’t a limitation, what would you create?

4. Leave a thought, idea, or question you genuinely care about.
